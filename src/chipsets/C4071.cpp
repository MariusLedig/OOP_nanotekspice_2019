...
nts::C4071::C4071(std::string const &value)
        : _name(value)
{
    _gates[0] = new nts::OrGate("gate1");
    _gates[1] = new nts::OrGate("gate2");
    _gates[2] = new nts::OrGate("gate3");
    _gates[3] = new nts::OrGate("gate4");
...
nts::Tristate nts::C4071::getValue() const {
    return _value;
}

void nts::C4071::setValue(nts::Tristate tristate) {
    _value = tristate;
}
